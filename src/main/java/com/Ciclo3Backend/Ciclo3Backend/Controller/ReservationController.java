...
import com.Ciclo3Backend.Ciclo3Backend.Services.ReservationServices;
...
public class ReservationController {
    ...
    @GetMapping("/{id}")
    public Optional<Reservation> getOneReservation(@PathVariable("id") int id){
        return reservationServices.getOneReservation(id);
    }
    ...
    public Reservation updateReservation(@RequestBody Reservation r){
        return reservationServices.updateReservation(r);
    }
    @DeleteMapping("/{id}")
